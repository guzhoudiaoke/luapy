from src.binchunk.binary_reader import BinaryReader
from src.binchunk.binary_chunk_header import BinaryChunkHeader
from src.vm.prototype import Prototype
