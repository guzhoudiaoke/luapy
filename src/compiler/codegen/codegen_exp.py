from src.compiler.ast.lua_exp import *
from src.compiler.codegen.func_info import FuncInfo
from src.compiler.lexer.lua_token import TokenKind
...
class CodegenExp:
    ...
    def process_func_def_exp(fi, exp, a):
        from src.compiler.codegen.codegen_block import CodegenBlock
